...
public class HumanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        list.add(new HumanDTO(R.drawable.img_human2, "상품명2 : selkfjl", "설명2 : esofijlks", "13000원"));
        list.add(new HumanDTO(R.drawable.img_human3, "상품명3 : selkfjl", "설명3 : esofijlks", "20000원"));
        list.add(new HumanDTO(R.drawable.img_human4, "상품명4 : selkfjl", "설명4 : esofijlks", "6900원"));
        list.add(new HumanDTO(R.drawable.img_human5, "상품명5 : selkfjl", "설명5 : esofijlks", "10900원"));
